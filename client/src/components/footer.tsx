      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Empowering global citizens through excellence in education since 1995.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-nilo-blue transition-colors"
              >
                <Facebook size={18} />
              </a>
              <a
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-nilo-blue mt-1" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-nilo-blue" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@nilo.edu</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} Nilo. All rights reserved. |{" "}
